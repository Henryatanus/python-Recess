...
class Vehicle:
    ...
    def display_info(self):
        print(f"This is my vechile info: {self.brand} {self.color} {self.year}{self.model}")
...
class Car(Vehicle):
    ...
    def display_info(self):
        super().display_info()
        print(f"Vechile Doors: {self.number_of_doors}")
...
class Motorcycle(Vehicle):
    ...
    def display_info(self):
        super().display_info()
        print(f"Required info: {self.type_of_bike}")
...
# Example usage:
car1 = Car("Toyota", "Camry", 2020, 4,"Black")
#motorcycle1 = Motorcycle("Honda", "YZF-R3", 2021, "SuperFast")
...
rect = Rectangle(140, 5)
print("RecArea", rect.area())
print("RecPerimeter:", rect.perimeter())